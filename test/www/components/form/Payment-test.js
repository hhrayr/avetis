  ...
  beforeEach((done) => {
    jsdom.env('<html><body></body></html>', [], (err, window) => {
      ...
      PaymentMethodsSelector =
        require('../../../../www/components/form/payment/PaymentMethodsSelector').default;
      CCPaymentMethod = require('../../../../www/components/form/payment/CCPaymentMethod').default;
      ECPaymentMethod = require('../../../../www/components/form/payment/ECPaymentMethod').default;
      CCValidUntil = require('../../../../www/components/form/payment/CCValidUntil').default;
      Select = require('../../../../www/components/form/Select').default;
      Input = require('../../../../www/components/form/Input').default;
      Checkbox = require('../../../../www/components/form/Checkbox').default;
      Payment = require('../../../../www/components/form/payment/Payment').default;
